...
namespace Inva.LawMax.Migrations
{
    ...
    [Migration("20240804114515_AddEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inva.LawCases.Cases.Case", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Inva.LawCases.Hearings.Hearing", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Inva.LawCases.Lawyers.Lawyer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CaseLawyer", b =>
                {
                    b.HasOne("Inva.LawCases.Cases.Case", null)
                        .WithMany()
                        .HasForeignKey("CasesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Inva.LawCases.Lawyers.Lawyer", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Inva.LawCases.Hearings.Hearing", b =>
                {
                    b.HasOne("Inva.LawCases.Cases.Case", "Case")
                        .WithMany("Hearings")
